(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Проеверить ответ',
                nextQuestionText: 'Следующий &raquo;',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Вопрос %current из %total',
                preventUnansweredText: 'Дожны отметить хотя бы 1 ответ',
                questionTemplateText:  '%count. %text',
                scoreTemplateText: '%score / %total',
                nameTemplateText:  '<span>Тест: </span>ПДД',
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        var picArray = ["../images/sl3.jpg", "../images/sl4.jpg"];
                        var pic = picArray[count];
                        questionHTML.append('<h3>' + formatQuestion + '</h3><img src=pic alt="">');
